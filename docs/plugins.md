...
| `hallmark` | claude, opencode, codex, agent | `hallmark`, `hallmark audit`, `hallmark redesign`, `hallmark study` | `npx skills add nutlope/hallmark --skill hallmark -g` | Anti-AI-slop design skill - builds, audits, redesigns, and studies UI with structural variety, twenty themes, and fifty-seven slop-test gates so outputs do not look AI-generated. |
